...
function CourseList() {
  ...
  return (
    <div className='mt-10'>
        <h2 className='font-bold text-3xl text-black flex justify-between items-center'>Your Courses
            <Button variant="outline" 
            onClick={()=>{GetCourseList()}}
            className="border-black bg-white text-black hover:bg-black hover:text-white"><RefreshCw/>Refresh</Button>
        </h2>
